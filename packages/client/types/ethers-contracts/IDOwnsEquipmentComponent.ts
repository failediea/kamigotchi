...
export interface IDOwnsEquipmentComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDOwnsEquipmentComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDOwnsEquipmentComponent;
  waitForDeployment(): Promise<this>;

  interface: IDOwnsEquipmentComponentInterface;
  ...
  "dec(uint256,uint256)": TypedContractMethod<
  ...
  "dec(uint256[],uint256)": TypedContractMethod<
    [entities: BigNumberish[], value: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  "get(uint256)": TypedContractMethod<[entity: BigNumberish], [bigint], "view">;
  ...
  "inc(uint256[],uint256)": TypedContractMethod<
    [entities: BigNumberish[], value: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "dec(uint256,uint256)"
  ): TypedContractMethod<
    [entity: BigNumberish, value: BigNumberish],
    [void],
    "nonpayable"
  ...
  ): TypedContractMethod<[entities: BigNumberish[]], [bigint[]], "nonpayable">;
  getFunction(
    nameOrSignature: "extract(uint256)"
  ...
  getFunction(
    nameOrSignature: "inc(uint256[],uint256)"
  ): TypedContractMethod<
    [entities: BigNumberish[], value: BigNumberish],
    [void],
    "nonpayable"
