...
export interface _HarvestAdminSystem extends BaseContract {
  ...
  stop: TypedContractMethod<[index: BigNumberish], [string], "nonpayable">;

  stopBatched: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "stopBatched"
  ): TypedContractMethod<[indices: BigNumberish[]], [void], "nonpayable">;
  getFunction(
