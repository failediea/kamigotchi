...
export interface KamiGachaRevealSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiGachaRevealSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiGachaRevealSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiGachaRevealSystemInterface;
  ...
  forceReveal: TypedContractMethod<
