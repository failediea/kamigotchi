...
export interface KamiSacrificeRevealSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "executeTypedBatch",
    values: [BigNumberish[]]
  ): string;
...
export interface KamiSacrificeRevealSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiSacrificeRevealSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiSacrificeRevealSystemInterface;
  ...
  executeTypedBatch: TypedContractMethod<
  ...
  ): TypedContractMethod<[commitID: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "executeTypedBatch"
  ): TypedContractMethod<[commitIDs: BigNumberish[]], [void], "nonpayable">;
  getFunction(
