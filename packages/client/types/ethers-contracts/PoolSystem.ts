...
export interface PoolSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addLiquidity"
...
export interface PoolSystem extends BaseContract {
  connect(runner?: ContractRunner | null): PoolSystem;
  waitForDeployment(): Promise<this>;

  interface: PoolSystemInterface;
