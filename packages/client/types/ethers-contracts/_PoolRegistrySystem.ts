...
export interface _PoolRegistrySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface _PoolRegistrySystem extends BaseContract {
  connect(runner?: ContractRunner | null): _PoolRegistrySystem;
  waitForDeployment(): Promise<this>;

  interface: _PoolRegistrySystemInterface;
  ...
  remove: TypedContractMethod<
    [indexA: BigNumberish, indexB: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  setDisabled: TypedContractMethod<
    [indexA: BigNumberish, indexB: BigNumberish, disabled: boolean],
    [void],
    "nonpayable"
  >;

  setFee: TypedContractMethod<
    [indexA: BigNumberish, indexB: BigNumberish, feeBps: BigNumberish],
    [void],
    "nonpayable"
  >;
