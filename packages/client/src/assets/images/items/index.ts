...
import ancient_automata from './ancient_automata.png';
import ancient_ledger from './ancient_ledger.png';
...
import elder_critter from './elder_critter.png';
import elder_gumdrop from './elder_gumdrop.png';
import elder_leafling from './elder_leafling.png';
...
import heirloom_automata from './heirloom_automata.png';
import heirloom_ledger from './heirloom_ledger.png';
...
import kamigotchi_world_passport_1_bit_green from './kamigotchi_world_passport_1_bit_green.png';
import kamigotchi_world_passport_1_bit_pink from './kamigotchi_world_passport_1_bit_pink.png';
import kamigotchi_world_passport_1_bit_red_and_white from './kamigotchi_world_passport_1_bit_red_and_white.png';
import kamigotchi_world_passport_blue from './kamigotchi_world_passport_blue.png';
import kamigotchi_world_passport_green from './kamigotchi_world_passport_green.png';
import kamigotchi_world_passport_grey from './kamigotchi_world_passport_grey.png';
import kamigotchi_world_passport_lime_green from './kamigotchi_world_passport_lime_green.png';
import kamigotchi_world_passport_orange from './kamigotchi_world_passport_orange.png';
import kamigotchi_world_passport_pink from './kamigotchi_world_passport_pink.png';
...
import mask_of_avarice from './mask_of_avarice.png';
import mask_of_contempt from './mask_of_contempt.png';
import mask_of_mischief from './mask_of_mischief.png';
...
import old_critter from './old_critter.png';
import old_gumdrop from './old_gumdrop.png';
import old_leafling from './old_leafling.png';
...
import swarming_cope from './swarming_cope.png';
import swarming_greed from './swarming_greed.png';
import swarming_wrath from './swarming_wrath.png';
import switchbox_imp from './switchbox_imp.png';
import teardrop_jewel from './teardrop_jewel.png';
import teeming_cope from './teeming_cope.png';
import teeming_greed from './teeming_greed.png';
import teeming_wrath from './teeming_wrath.png';
...
import veil_of_avarice from './veil_of_avarice.png';
import veil_of_contempt from './veil_of_contempt.png';
import veil_of_mischief from './veil_of_mischief.png';
import vipp from './vipp.png';
import visage_of_avarice from './visage_of_avarice.png';
import visage_of_contempt from './visage_of_contempt.png';
import visage_of_mischief from './visage_of_mischief.png';
import wise_critter from './wise_critter.png';
import wise_gumdrop from './wise_gumdrop.png';
import wise_leafling from './wise_leafling.png';
...
export const ItemImages = {
  ...
  ancient_automata: ancient_automata,
  ancient_ledger: ancient_ledger,
  ...
  elder_critter: elder_critter,
  elder_gumdrop: elder_gumdrop,
  elder_leafling: elder_leafling,
  empty_cup: empty_cup,
  ...
  heirloom_automata: heirloom_automata,
  heirloom_ledger: heirloom_ledger,
  ...
  kamigotchi_world_passport_1_bit_green: kamigotchi_world_passport_1_bit_green,
  ...
  kamigotchi_world_passport_lime_green: kamigotchi_world_passport_lime_green,
  kamigotchi_world_passport_orange: kamigotchi_world_passport_orange,
  kamigotchi_world_passport_pink: kamigotchi_world_passport_pink,
  kamigotchi_world_passport_purple: kamigotchi_world_passport_purple,
  ...
  mask_of_avarice: mask_of_avarice,
  mask_of_contempt: mask_of_contempt,
  mask_of_mischief: mask_of_mischief,
  ...
  obol: obol,
  old_critter: old_critter,
  old_gumdrop: old_gumdrop,
  old_leafling: old_leafling,
  ...
  swarming_cope: swarming_cope,
  swarming_greed: swarming_greed,
  swarming_wrath: swarming_wrath,
  switchbox_imp: switchbox_imp,
  teardrop_jewel: teardrop_jewel,
  teeming_cope: teeming_cope,
  teeming_greed: teeming_greed,
  teeming_wrath: teeming_wrath,
  timber: timber,
  toadstool_liquor: toadstool_liquor,
  uninteresting_paste: uninteresting_paste,
  unmarked_data_chip: unmarked_data_chip,
  veil_of_avarice: veil_of_avarice,
  veil_of_contempt: veil_of_contempt,
  veil_of_mischief: veil_of_mischief,
  vipp: vipp,
  visage_of_avarice: visage_of_avarice,
  visage_of_contempt: visage_of_contempt,
  visage_of_mischief: visage_of_mischief,
  wise_critter: wise_critter,
  wise_gumdrop: wise_gumdrop,
  wise_leafling: wise_leafling,
